...
public class CompromissoDao extends Dao {
	...
	public List<CompromissoVo> findAllCompromissos(){
		StringBuilder query = new StringBuilder("SELECT rowid id, cd_funcionario cdFuncionario, cd_agenda cdAgenda, data, hora FROM compromissos");
	...
	public void insertCompromisso(CompromissoVo compromissoVo) {
		StringBuilder query = new StringBuilder("INSERT INTO compromisso (cd_funcionario, cd_agenda, data, hora) VALUES (?,?,?,?)");
