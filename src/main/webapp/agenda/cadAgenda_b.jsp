...
<body class="bg-secondary">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					</a> <a id="excluir" class="btn btn-primary" style="width: 75px;">
	...
	<script>
		// Configura o modal de exclusao com a agenda selecionada
		...
		modalExclusao.addEventListener('show.bs.modal', function(event) {
			...
			botaoConfirmar.href = 'excluirAgendas.action?agendaVo.rowid='
					+ rowid;
		});
	</script>
